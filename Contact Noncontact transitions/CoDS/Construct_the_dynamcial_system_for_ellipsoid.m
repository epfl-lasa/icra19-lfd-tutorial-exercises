function [A,Dem_i,check]=Construct_the_dynamcial_system_for_ellipsoid(Center,Radiusx,Radiusy,Option)
...
for i=1:size(Dem_i,2)
    if (((Center(1)-Dem_i(1,i))^2)/(Radiusx^2)+((Center(2)-Dem_i(2,i))^2)/(Radiusy^2)-1<0)
