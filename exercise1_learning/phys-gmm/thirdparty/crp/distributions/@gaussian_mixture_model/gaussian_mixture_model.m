function d = gaussian_mixture_model(varargin)
%GAUSSIAN_MIXTURE_MODEL mixture model class constructor.
...
par = mixture_model(varargin{:});
this.Z = 1;
d = class(this,'gaussian_mixture_model',par);
